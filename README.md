...
- [shieldcode](https://github.com/nikolasdehor/shieldcode) by [Nikolas de Hor](https://github.com/nikolasdehor) - Security hardening skill for Claude Code with OWASP-aligned protections (SQLi, XSS, SSRF, path traversal).
- [visual-eyes](https://github.com/nikolasdehor/visual-eyes) by [Nikolas de Hor](https://github.com/nikolasdehor) - Claude Code skill for visual accessibility analysis (contrast, font size, spacing) with automatic reporting.
